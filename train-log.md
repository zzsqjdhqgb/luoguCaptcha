...
---
 ...
 - [x] 现阶段的学习率下降可能有些激进，需要重构

**目前还没加正则化，先450epoch试试**

感觉现在lr还是衰减太快，一直有点后劲不足。先把lr下限提高（failed, val_loss 0.2150, worse）
...
好像后期loss有点太大，尝试改成300epoch试试(failed)
...
然后再试试val loss不降再减小lr的策略。比较成功，loss压到了0.11
